...
function Cards({ item }) {
  ...
  return (
    <div className="card" style={{width: "18rem", borderWidth: "2px"}}>
      <img  src={rigoImageUrl} className="card-img-top" style={{ height: "10rem", borderWidth: "2px", borderStyle: "solid", borderColor: "#333"}} alt="Item" />
      <div className="card-body">
        ...
        <div className="d-flex justify-content-between">
          <Link to={`/${item.type === "planet" ? "planet" : item.type === "vehicle" ? "vehicle" : "character"}/${item.uid}`} className="btn btn-primary btn-sm">
            more...
          </Link>
          <button 
